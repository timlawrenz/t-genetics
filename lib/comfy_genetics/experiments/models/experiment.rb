module ComfyGenetics
  class Experiment < ComfyGenetics::ApplicationRecord
    include AASM

    belongs_to :chromosome, class_name: 'ComfyGenetics::Chromosome'
    belongs_to :current_generation, class_name: 'ComfyGenetics::Generation', foreign_key: 'current_generation_id', optional: true
