...
module ComfyGenetics
  class WriteTrainingFiles < GLCommand::Callable # TODO: GLCommand
    BASE_FOLDER = '/home/tim/source/essdee/EveryDream2trainer/' # TODO: This path is hardcoded and user-specific

    requires :organism # TODO: ComfyGenetics::Organism

    def call
      organism_hash = organism.to_hsh # TODO: ComfyGenetics::Organism
    ...
    def identifier
      # TODO: ComfyGenetics::Organism, ComfyGenetics::Chromosome, ComfyGenetics::Generation
